...
const useStyles = makeStyles((theme) => ({
  mainWrapper: {
    backgroundColor: theme.palette.bordabox, //DARK MODE Systech Tecnologia - Ivanildo Cândido//
    display: "flex",
  ...
  newMessageBox: {
    backgroundColor: theme.palette.newmessagebox, //DARK MODE Systech Tecnologia - Ivanildo Cândido//
    width: "100%",
    display: "flex",
    padding: "7px",
    alignItems: "center",
  ...
  messageInputWrapper: {
    padding: 6,
    marginRight: 7,
    backgroundColor: theme.palette.inputdigita, //DARK MODE Systech Tecnologia - Ivanildo Cândido//
    display: "flex",
    borderRadius: 20,
    flex: 1,
  },
  ...
  if (inputMessage || showSelectMessageCheckbox) {
    return (
      <IconButton
        ...
        component="span"
        onClick={
          showSelectMessageCheckbox ? handleOpenModalForward : handleSendMessage
        }
        disabled={loading}
      >
        {showSelectMessageCheckbox ? (
