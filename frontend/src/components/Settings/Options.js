...
const useStyles = makeStyles((theme) => ({
  ...
  tab: {
    backgroundColor: theme.palette.options,  //DARK MODE Systech Tecnologia - Ivanildo Cândido//
    borderRadius: 4,
    width: "100%",
    "& .MuiTab-wrapper": {
      color: theme.palette.fontecor,
    },   //DARK MODE Systech Tecnologia - Ivanildo Cândido//
...
export default function Options(props) {
  ...
  useEffect(() => {
    if (Array.isArray(settings) && settings.length) {
	  ...
	  {/*Systech Tecnologia - Ivanildo Cândido SAUDAÇÃO*/}
