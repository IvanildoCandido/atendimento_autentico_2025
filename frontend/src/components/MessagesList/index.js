...
import whatsBackgroundDark from "../../assets/wa-background-dark.png"; //DARK MODE Systech Tecnologia - Ivanildo Cândido//
...
const useStyles = makeStyles((theme) => ({
  ...
  messagesList: {
    backgroundImage: theme.mode === 'light' ? `url(${whatsBackground})` : `url(${whatsBackgroundDark})`, //DARK MODE Systech Tecnologia - Ivanildo Cândido//
    display: "flex",
    flexDirection: "column",
    flexGrow: 1,
